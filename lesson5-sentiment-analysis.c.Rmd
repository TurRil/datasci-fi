...
```{r}
ggplot(sentiments_per_month, aes(x = month, y = n, fill = sentiment)) +
    geom_col() 
...
```
```{r}
#as.numeric(sentiments_per_month$month)

# first month
-0.19 + 0.00001605*14365

# last month
-0.19 + 0.00001605 * max(as.numeric(sentiments_per_month$month))
```
...
miss universe / miss usa - marked as negative - neutral
no wonder - negative - neutral
